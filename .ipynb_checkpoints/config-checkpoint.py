...
# info_dict = {
#     'DATA_PATH': DATA_PATH,
#     'TRAIN_SONGS_INFO_PATH': TRAIN_SONGS_INFO_PATH,
#     'TRAIN_DATA_PATH': TRAIN_DATA_PATH,
#     'TEST_DATA_PATH': TEST_DATA_PATH,
#     'QUALITATIVE_TEST_DATA_PATH': QUALITATIVE_TEST_DATA_PATH,
#     'ALL_SONGS_INFO_PATH': ALL_SONGS_INFO_PATH,
#     'PICKLES_DIR_PATH': PICKLES_DIR_PATH,
#     'SONG2INFO_PICKLE_PATH': SONG2INFO_PICKLE_PATH,
#     'NUM_TEST_SAMPLES_QUANTITATIVE': NUM_TEST_SAMPLES_QUANTITATIVE,
#     'NUM_TEST_SAMPLES_QUALITATIVE': NUM_TEST_SAMPLES_QUALITATIVE,
#     'OVERWRITE_PREPROCESS_TRAINING_DATA': OVERWRITE_PREPROCESS_TRAINING_DATA,
#     'LSTM_DIM': LSTM_DIM,
#     'EMB_DIM': EMB_DIM,
#     'MAX_LEN': MAX_LEN,
...
#     'PAD_TOKEN': PAD_TOKEN,
#     'UNK_TOKEN': UNK_TOKEN,
#     'ITEM_FREQUENCY_THRESH': ITEM_FREQUENCY_THRESH,
#     'POPULAR_SONGS_PERCENTAGE': POPULAR_SONGS_PERCENTAGE,
#     'EPOCHS': EPOCHS,
#     'METRICS_EVALUATION_AND_SAVE_MODEL_EVERY_N_BATCH': METRICS_EVALUATION_AND_SAVE_MODEL_EVERY_N_BATCH,
#     'SHOW_LOSS_EVERY_N_BATCH': SHOW_LOSS_EVERY_N_BATCH,
#     'WRITE_SUMMARY': WRITE_SUMMARY,
#     'NAME': NAME,
#     'NAME_BREAKDOWN': NAME_BREAKDOWN,
#     'SUMMARY_DIR': SUMMARY_DIR,
#     'METRICS_SUMMARY_DIR': METRICS_SUMMARY_DIR,
#     'MODEL_DIR': MODEL_DIR,
#     'K': K,
#     'NUM_RECOMMENDATION_TIMESTEPS': NUM_RECOMMENDATION_TIMESTEPS,
#     'QUALITATIVE_RESULTS_ON_HANDPICKED_SONGS': QUALITATIVE_RESULTS_ON_HANDPICKED_SONGS,
#     'PRINT_QUALITATIVE_RESULTS': PRINT_QUALITATIVE_RESULTS,
#     'WRITE_QUALITATIVE_RESULTS': WRITE_QUALITATIVE_RESULTS,
#     'QUALITATIVE_RESULTS_DIR': QUALITATIVE_RESULTS_DIR,
